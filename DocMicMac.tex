...
%\includeonly{Generalites/QuickStartSimplified-Tools-2}
%\includeonly{DocRef/Advanced-MicMac2}
\includeonly{DocAlgo/DSensibility}
%\includeonly{Annexes/Vrac2}
...
\newcommand{\Tran}{\ensuremath {^{\intercal} }}
\newcommand{\Trans}{\ensuremath {^{\intercal} \!}}
\newcommand{\Transs}{\ensuremath {^{\intercal} \!\!}}
\newcommand{\Transss}{\ensuremath {^{\intercal} \!\!\!}}
...
\include{Generalites/SomReal}
% -------------------
\include{Generalites/QuickStartSimplified-Tools}
\include{Generalites/QuickStartSimplified-Tools-2}
\include{Generalites/QuickStart}
\include{Generalites/QuickStart_Apero}
\include{Generalites/QuickStartOthers}

\include{Generalites/InteractiveTool}

\include{Generalites/FullAutomaticTools}

% -------------------

\include{Generalites/ParamSpec}

\include{Generalites/NameFileSpec}

\include{Generalites/UseCase2D}

\include{Generalites/ImageFilter}
...
\include{DocRef/ConvTool}
\include{DocRef/GeoLocalisation}

\include{DocRef/Advanced-TieP}
\include{DocRef/Advanced-Apero1}
\include{DocRef/Advanced-MicMac1}
\include{DocRef/Advanced-MicMac2}

\include{DocRef/Satellite}
...
%---------------------------------------------
\include{DocAlgo/DAMultiRes}

%---------------------------------------------

\include{DocAlgo/DACorrel}

%---------------------------------------------
\chapter{Algorithmes de filtrages rapides}

%---------------------------------------------
\include{DocAlgo/DAEnergetik}
\include{DocAlgo/DAOrient}
\include{DocAlgo/DSensibility}
...
% \include{DocUtil/DUGen}

%---------------------------------------------

\include{DocUtil/DUMecaGen} %\chapter{G\'en\'eralit\'es}


%---------------------------------------------
%\chapter{Autres Sections}
\include{DocUtil/DUAutreSec} %\chapter{G\'en\'eralit\'es}

%---------------------------------------------
\include{DocUtil/DUMec}
...
\include{DocProg/Doc0CPP}
\include{DocProg/MMCourse_day_4-5_matching}
\include{DocProg/Doc_Qt_tools}
\include{DocProg/ConvSaisie3D}
...
\include{Annexes/Formats}

\include{Annexes/Vrac}
%}

\include{Annexes/Vrac2}
\include{Annexes/Vrac3}
...
\begin{thebibliography}{AAA}
   ...
   \bibitem[Rupnik  2020 ]{StrLessPoint}   Ewelina Rupnik, Marc Pierrot Deseilligny, 2020 , 
            "Towards structureless bundle adjustment with two- and three-view structure approximation ",
            https://hal.archives-ouvertes.fr/hal-02499312;
