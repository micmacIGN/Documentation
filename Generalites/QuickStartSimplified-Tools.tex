...
\subsection{Detecting fault in GCP and  Robust "Bascule"  with {\tt BAR}}
\label{Sec:BAR}

     % - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{When is it usefull}
...
\subsubsection{Mathematicall modeling}
...
correspond to $D_0$ in equation ~\ref{Eq:Reproj:Bar}.
     ...
     % - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Analyse of results in file {\tt ResulBar.txt}}
