...
The graph of image links is exportable with {\tt MNetworkExport}: copy \url{https://raw.githubusercontent.com/micmacIGN/Documentation/master/Data/schnaps_disp_graph/disp_graph.html} alongside the
output of Schnaps ({\tt data.js}) and open the html file on a web browser.
