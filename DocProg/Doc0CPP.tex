...
\noindent To read this new file \texttt{L2D\_mesure-S2D.xml} programmatically, we call \texttt{StdGetFromPCP} in C++ code: \newline


\begin{verbatim}
cXml_SetMeasureGlob3DLine mesures_lines = StdGetFromPCP("L2D_mesure-S2D.xml",SetMeasureGlob3DLine);
\end{verbatim}
